...
또, 일기는 그 날의 좋았던 점과 나빴던 점들이 모두 담겨져 있어 온전히 나의 내면을 마주할 수 있는 좋은 수단이라 생각합니다.
...
이모지로 감정을 표현합니다. (Heroku가 자고있으면 시간이 약간 걸릴 수 있습니다!)
...
리액트 프로젝트인 만큼 뿌듯하고, 프론트엔드 개발의 재미를 알 수 있었던 기회였습니다.
